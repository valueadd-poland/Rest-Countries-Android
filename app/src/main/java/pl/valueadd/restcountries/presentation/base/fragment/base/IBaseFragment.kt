...
interface IBaseFragment : ISupportFragment {
    ...
    /**
     * Calls on host [BaseMVPActivity][pl.valueadd.restcountries.presentation.base.activity.BaseMVPActivity] a
     * [findFragment(Class)][pl.valueadd.restcountries.presentation.base.activity.BaseMVPActivity.findFragment]
     * method.
     */
